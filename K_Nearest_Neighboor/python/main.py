...
def calculate_euclidean_similarity(person1_name: str, person2_name: str) -> dict:
...
def find_k_nearest_neighboors(person_name: str, k: int) -> list:
...
# TODO(CCnova): make the output better
